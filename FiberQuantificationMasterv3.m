...
warn_count_picro_green = 0;
warn_count_picro_green_bw = 0;
warn_count_picro_green_bw_branch = 0;
warn_count_picro_green_bw_skel = 0;
warn_count_picro_green_bw_strel = 0;
warn_count_picro_green_noise = 0;
warn_count_picro_red = 0;
warn_count_picro_red_bw = 0;
warn_count_picro_red_bw_branch = 0;
warn_count_picro_red_bw_skel = 0;
warn_count_picro_red_bw_strel = 0;
warn_count_picro_red_noise = 0;
...
%     stored_norm_im{i} = stored_im{i}; % To bypass normalization
    ...
    if not(any(any(picro_green)))
        warnings_picro_green(warn_count_picro_green+1) = i;
        warn_count_picro_green = warn_count_picro_green + 1;
    end
    
    if not(any(any(picro_green_bw)))
        warnings_picro_green_bw(warn_count_picro_green_bw+1) = i;
        warn_count_picro_green_bw = warn_count_picro_green_bw + 1;
    end

    if not(any(any(picro_green_bw_branch)))
        warnings_picro_green_bw_branch(warn_count_picro_green_bw_branch+1) = i;
        warn_count_picro_green_bw_branch = warn_count_picro_green_bw_branch + 1;
    end
    
    if not(any(any(picro_green_bw_skel)))
        warnings_picro_green_bw_skel(warn_count_picro_green_bw_skel+1) = i;
        warn_count_picro_green_bw_skel = warn_count_picro_green_bw_skel + 1;
    end   
    
    if not(any(any(picro_green_bw_strel)))
        warnings_picro_green_bw_strel(warn_count_picro_green_bw_strel+1) = i;
        warn_count_picro_green_bw_strel = warn_count_picro_green_bw_strel + 1;
    end    
    
    if not(any(any(picro_green_noise)))
        warnings_picro_green_noise(warn_count_picro_green_noise+1) = i;
        warn_count_picro_green_noise = warn_count_picro_green_noise + 1;
    end
     
    if not(any(any(picro_red)))
        warnings_picro_red(warn_count_picro_red+1) = i;
        warn_count_picro_red = warn_count_picro_red + 1;
    end
    
    if not(any(any(picro_red_bw)))
        warnings_picro_red_bw(warn_count_picro_red_bw+1) = i;
        warn_count_picro_red_bw = warn_count_picro_red_bw + 1;
    end

    if not(any(any(picro_red_bw_branch)))
        warnings_picro_red_bw_branch(warn_count_picro_red_bw_branch+1) = i;
        warn_count_picro_red_bw_branch = warn_count_picro_red_bw_branch + 1;
    end
    
    if not(any(any(picro_red_bw_skel)))
        warnings_picro_red_bw_skel(warn_count_picro_red_bw_skel+1) = i;
        warn_count_picro_red_bw_skel = warn_count_picro_red_bw_skel + 1;
    end   
    
    if not(any(any(picro_red_bw_strel)))
        warnings_picro_red_bw_strel(warn_count_picro_red_bw_strel+1) = i;
        warn_count_picro_red_bw_strel = warn_count_picro_red_bw_strel + 1;
    end    
    
    if not(any(any(picro_red_noise)))
        warnings_picro_red_noise(warn_count_picro_red_noise+1) = i;
        warn_count_picro_red_noise = warn_count_picro_red_noise + 1;
    end
